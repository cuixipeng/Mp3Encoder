...
Java_com_phuket_tour_studio_video_VideoPlayActivity_nativeGlesPlay__Ljava_lang_String_2Ljava_lang_Object_2(
        JNIEnv
*env,
...
env->
ReleaseStringUTFChars(yuv420pPath_, yuv420pPath
);
}
...
extern "C"
JNIEXPORT void JNICALL
Java_com_phuket_tour_studio_video_VideoPlayActivity_nativeWindowPlay__Ljava_lang_String_2Ljava_lang_Object_2(
        JNIEnv
*env,
jobject instance, jstring
yuv420pPath_,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_phuket_tour_studio_video_VideoPlayActivity_onDestory(JNIEnv
*env,
jobject instance
) {
if (gles_play)
